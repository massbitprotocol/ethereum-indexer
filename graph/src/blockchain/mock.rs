...
use super::{
    block_stream::BlockWithTriggers, Block, BlockHash, BlockPtr, Blockchain, BlockchainKind,
    DataSource, DataSourceTemplate, IngestorAdapter, MappingTrigger, NodeCapabilities,
    RuntimeAdapter, TriggerData, TriggerFilter, TriggersAdapter, UnresolvedDataSource,
...
pub struct MockIngestorAdapter;

#[async_trait]
impl<C: Blockchain> IngestorAdapter<C> for MockIngestorAdapter {
    ...
    async fn ingest_block(&self, _hash: &BlockHash) -> Result<Option<BlockHash>, IngestorError> {
        todo!()
    }
...
impl Blockchain for MockBlockchain {
    ...
    type IngestorAdapter = MockIngestorAdapter;
